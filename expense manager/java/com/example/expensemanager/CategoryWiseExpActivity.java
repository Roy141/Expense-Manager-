...
public class CategoryWiseExpActivity extends AppCompatActivity {
    TableLayout tl;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_category_wise_exp);
        ...
        while (c.moveToNext()) {
            ...
            String q = "Select Category from exp where id='" + id + "' ";
            ...
            while (a.moveToNext()) {
                ...
                if (!(a1.contains(y))) {
                    ...
                    int sum = 0;
                    // db=openOrCreateDatabase("EXPENSE",MODE_PRIVATE,null);
                    String b = "Select Amount from exp where Category='" + y + "' and id='" + id + "' ";
                    ...
                    String id1 = "E" + t;
                    String q1 = "insert into catexpense values('" + id1 + "','" + d + "','" + y + "','" + sum + "')";
                    db = openOrCreateDatabase("EXPENSE", MODE_PRIVATE, null);
                    try {
                        db.execSQL(q1);
        ...
        db = openOrCreateDatabase("EXPENSE", MODE_PRIVATE, null);
        String sq = "Select * from catexpense";
        c = db.rawQuery(sq, null);
        while (c.moveToNext()) {
            String id=c.getString(0);
